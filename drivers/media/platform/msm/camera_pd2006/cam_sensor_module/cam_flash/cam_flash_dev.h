...
* 2017.12.20
*/
enum msm_camera_flash_num_t {
	FLASH_REAR,
	FLASH_FRONT,
	FLASH_LCD,
	MAX_FLASHS,
};
/* add by vivo wenjun end */
...
struct cam_flash_ctrl {
	...
	/* luzhi add begin for flash relate new function*/
	int32_t 						led_count;
	ktime_t 						startTime;
	bool 							ir_irq_enable;
	int32_t 						first_led_on;
	bool 							camera_flash_mode;
/* I2C related setting */
	...
	uint32_t gpio_flash_en;
	enum flash_func_type flash_function;
	/* luzhi add end for flash relate new function*/
};
