...
struct cam_sensor_ctrl_t {
	...
	struct regulator *cam_vdd_regulator;//vivo dongzhixiang add to optimize power consumption 2019/5/31
	uint32_t cam_vdd_max_voltage;//vivo dongzhixiang add to optimize power consumption 2019/5/31 
	uint32_t cam_vdd_min_voltage;//vivo dongzhixiang add to optimize power consumption 2019/5/31
	uint32_t cam_vdd_target_voltage;//vivo dongzhixiang add to optimize power consumption 2019/7/12
	uint32_t should_standby;      //vivo gaoshang add to support sharded-mipi 2020/3/30
};
