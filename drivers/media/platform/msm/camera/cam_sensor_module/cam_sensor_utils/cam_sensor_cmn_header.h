...
//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
enum vivo_sensor_compatible_t {
	COMPATIBLE_DEFAULT,
	ONLY_DOUBLE_SENSORID,
	DOUBLE_SENSORID_AND_COMPATIBLE,
	ONLY_COMPATIBLE_EXTEND1,
	BOTH_FOR_COMPTIBLE,
	MAX_COMPTIBLE,
};
...
struct cam_camera_slave_info {
	...
	uint8_t     extend_data1_type;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint8_t     extend_addr1_type;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint8_t     extend_data2_type;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint8_t     extend_addr2_type;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint16_t    extend_slave_addr1;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint16_t    extend_slave_addr2;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint32_t    extend_reg_addr1;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint32_t    extend_reg_data1;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint32_t    extend_data_mask1;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint32_t    extend_reg_addr2;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint32_t    extend_reg_data2;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint32_t    extend_data_mask2;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint16_t 	probe_flag;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	/*hujin add for thermal meter begin*/
	uint16_t	sensor_thermal_addr;
	uint16_t	sensor_thermal_mask;
	uint16_t	sensor_thermal_shift;
...
struct cam_sensor_board_info {
	...
	struct vivo_hiz_config hiz_config;
};
