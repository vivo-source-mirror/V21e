...
enum camera_flash_opcode {
	...
	CAMERA_SENSOR_FLASH_OP_FIREFLICKER,
...
struct cam_camera_slave_info {
	...
	uint32_t    thermal_addr;//vivo dongzhixiang add for thermal reed 2019/4/13
	uint16_t 	probe_flag;//vivo dongzhixiang add for dual sensorID and module comaptible 2019/4/13
	uint16_t 	sensor_temperature;//vivo dongzhixiang add to get sensor temperature 2019/7/20
};
