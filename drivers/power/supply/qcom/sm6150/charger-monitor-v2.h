...
#define BAT_HEALTH_OV_DELTA_MV	120
...
static int default_normal_tc_data_rc[] = {9, 7};
...
static int default_primary_fbon_tc_data_rc[] = {4, 3};
...
static int default_parallel_fbon_tc_data_rc[] = {4, 3};
...
static int default_primary_fboff_tc_data_rc[] = {4, 3};
...
static int default_parallel_fboff_tc_data_rc[] = {4, 3};
...
static int default_usb_conn_temp_heat_data_rc[] = {2, 4};
