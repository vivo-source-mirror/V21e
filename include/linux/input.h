...
struct input_handler {
	...
	void *private;
	void (*event_timestamp)(struct input_handle *handle,
			unsigned int type, unsigned int code, int value, ktime_t timestamp);
	void (*events_timestamp)(struct input_handle *handle,
		       const struct input_value *vals, unsigned int count, ktime_t timestamp);
...
void input_event_timestamp(struct input_dev *dev, unsigned int type, unsigned int code, int value, ktime_t timestamp);
