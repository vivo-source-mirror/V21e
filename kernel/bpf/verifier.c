...
static const char * const func_id_str[] = {
	...
	[BPF_FUNC_skb_get_sock_comm] = "bpf_skb_get_sock_comm",
	/*vivo jiangyu add for VIVO_NETWORK_STATS end*/
	/* vivo zhangtaorjyb add for IFACE_TCP_UDP_STATS_DETAIL start begin */
	[BPF_FUNC_get_sk_l4_protocol] = "bpf_get_sk_l4_protocol",
	/* vivo zhangtaorjyb add for IFACE_TCP_UDP_STATS_DETAIL start end */
};
