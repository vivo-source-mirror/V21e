...
{
#ifdef CONFIG_DEBUG_FS
	/* Add debug information.@fanyongxiang */
	pr_debug("ASoC: %s: stream: %s,"
		"be->dpcm[stream].users: %d,\n"
		"fe->dpcm[stream].state: %s,"
		"be->dpcm[stream].state: %s,\n"
		"fe->dpcm[stream].runtime_update: %d,"
		"be->dpcm[stream].runtime_update: %d,\n"
		"FE name: %s, BE name: %s.\n",
		__func__, stream ? "capture" : "playback",
		be->dpcm[stream].users,
		dpcm_state_string(fe->dpcm[stream].state),
		dpcm_state_string(be->dpcm[stream].state),
		fe->dpcm[stream].runtime_update,
