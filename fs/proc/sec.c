...
#define SEC_ENABLE_REG_ADDR         0x00780498
#define SEC_SERIAL_NUM_ADDR         0x00786134
#define SEC_ROOT_CERT_HASH_ADDR     0x00780228
#define SEC_MASK_BIT_56             0XFFFFFFFFFFFFFF00
#define SEC_MASK_BIT_32             0XFFFFFFFF00000000
#define SEC_RPMB_KEY_PROVISION_ADDR 0x00780218
#define SEC_ANTI_ROLLBACK_ENABLE_ADDR 0x007801CC
